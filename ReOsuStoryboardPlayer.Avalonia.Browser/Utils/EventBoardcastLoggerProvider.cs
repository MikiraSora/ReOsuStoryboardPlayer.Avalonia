...
public class EventBoardcastLoggerProvider : ILoggerProvider
{
    ...
    static EventBoardcastLoggerProvider()
    {
    ...
    public record LogEntry(LogLevel logLevel, EventId eventId, object state, Exception exception, string logRecord)
    {
        public LogEntry() : this(default, default, default, default, default)
        {
        }
    }
    ...
    private class ConsoleLogger : ILogger
    {
            ...
            Func<TState, Exception, string> formatter)
        {
            ...
            var overDays = (int) (now - EventBoardcastLoggerProvider.startTime).TotalDays;
            ...
            WeakReferenceMessenger.Default.Send(new LogEntry(logLevel, eventId, state, exception, logRecord));
        }
